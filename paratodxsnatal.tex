...
\makeatother
% --- fim da sequência ---
% Deve-se fazer a referência usando \namedlabel{chave para referência}{Nome a ser exibido}. Ex.: se quisermos um link para o item "Argumento" em uma descrição, devemos colocar, em vez de "\item[Argumento\label{<nome>}]" a alternativa "\item[\namedlabel{<nome>}{Argumento}]".
