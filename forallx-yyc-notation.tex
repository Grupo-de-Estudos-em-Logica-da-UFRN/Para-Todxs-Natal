...
\paragraph{Completude funcional.} Alguns textos descrevem a LVF como \emph{verofuncionalmente completa} ou ainda como \textit{adequadamente expressiva} em vez de funcionalmente completa.
