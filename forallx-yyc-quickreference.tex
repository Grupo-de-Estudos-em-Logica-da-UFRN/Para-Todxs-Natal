...
\textsc{(1)} {\small \meta{c} não deve ocorrer fora da subprova rotulada.}

\textsc{(2)} {\small \meta{x} não deve ocorrer em $\meta{A}(\meta{c})$}
\end{raggedright}
...
%
%\medskip\begin{raggedright}
%{\small \noindent \meta{c} não pode ocorrer em nenhuma suposição não descartada, em $\exists \meta{x}\meta{A}(\ldots \meta{x} \ldots \meta{x}\ldots)$, ou em \meta{B}}
...
\end{fitchproof}
\medskip\begin{raggedright}
{\small \noindent \meta{c} não deve ocorrer fora da subprova rotulada.}
