...
\meta{c} não pode ocorrer em nenhuma undischarged assumption<<obs>>
...
\medskip\begin{raggedright}
\noindent \meta{c} não pode ocorrer em nenhuma undischarged assumption<<obs>>, em $\exists \meta{x}\meta{A}(\ldots \meta{x} \ldots \meta{x}\ldots)$, ou em \meta{B}\end{raggedright}\vfill\columnbreak
