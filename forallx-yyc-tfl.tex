...
É o símbolo `$\eor$' que na tabela da página \pageref{table:TFLConnectives} foi chamado de \define{disjuncao}. 
...
$$(C \eif R)$$
O conectivo `\eif' é chamado de \define{condicional}.
