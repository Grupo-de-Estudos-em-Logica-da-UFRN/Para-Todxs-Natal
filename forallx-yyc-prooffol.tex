...
\end{fitchproof}
Isso é ilegítimo, pois `$\forall x$' não é o  operador lógico principal da linha ~1  (Se você não se lembra bem por que esse tipo de inferência é imprópria, volte ao Capítulo \ref{s:MoreMonadic} e releia especialmente a Seção 16.5  ????).
