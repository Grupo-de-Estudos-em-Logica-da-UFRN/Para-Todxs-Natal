...
No entanto, outros predicados dizem respeito a \definepl{relation} entre duas ou mais coisas.
...
\end{description}
Definimos uma \define{FOL expression} como qualquer sequência de símbolos da LPO.
