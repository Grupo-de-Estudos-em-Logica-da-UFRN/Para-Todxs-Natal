...
Este argumento também é válido---você pode provavelmente dizer---mas para testá-lo é preciso uma tabela de verdade com
 $2^{20} = 1048576$ linhas.  A princípio, podemos configurar uma máquina para gerar tabelas de verdade e nos relatar quando o processo terminar. Na prática, argumentos mais complexos na LVF tornam-se \emph{intratável} se usamos tabelas de verdade. 
...
Existem, de fato, sistemas que  codificam modos de raciocinar sobre todas as interpretações possíveis. Eles foram desenvolvidos na década de 1950 por Evert Beth e Jaakko Hintikka.  Mas não iremos seguir este caminho.  Ao invés disso,  nossa atenção será voltada para dedução natural. 
