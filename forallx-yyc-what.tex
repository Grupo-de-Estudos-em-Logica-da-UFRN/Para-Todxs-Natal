...
As expressões abaixo são frequentemente usadas para indicar a conclusão de um argumento:
	...
	\end{center}
Por esse motivo são, às vezes, chamadas de \define{express{\~o}es indicativas de conclus{\~a}o}.
...
Ou seja, suponha que um cenário hipotético que viola alguma lei da física não possa ser considerado como uma situação legitimamente aceitável que justifique refutar um argumento.
...
Podemos chamar de \define{nomologicamente valido} um argumento para o qual não há contraexemplos que não violem as leis da natureza.
